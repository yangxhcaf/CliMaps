...
library(ncdf)
#open the file
ncdf.file <- open.ncdf("~/downloads/air.mon.mean.nc")
#get the lon-lat grid and times
lon.grid <- get.var.ncdf(ncdf.file, "lon")
lat.grid <- get.var.ncdf(ncdf.file, "lat")
time <- get.var.ncdf(ncdf.file, "time")
#get the array of data.
data <- get.var.ncdf(ncdf.file)
```
